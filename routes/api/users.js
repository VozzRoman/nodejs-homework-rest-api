...
const {getCurrent, updateSubscrition, updateByIdSubscrition, updateAvatar, verifyEmail} = require('../../controllers/users/index');
...
router.get('/verify/:verificationToken', ctrWrapper(verifyEmail));
